<body>
        <div class="sidebar">
          ...
          <ul class="menu">
            ...
            <li><a href="overload.php"><i class="bx bxs-user-check"></i><span>Overload Overview</span></a></li>
            <li><a href="reports.php"><i class='bx bxs-book-alt'></i><span>reports generation</span></a></li>
